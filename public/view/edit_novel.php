...
<body>
    ...
    <main class="container mt-3">
        ...
        $sth = $pdo->query($query);
        $row = $sth->fetch();
        echo "<form action=\"../../function/update.php?id_truyen={$row['id_truyen']}\" name=\"truyen\" method=\"POST\" class=\"w-50 m-auto mt-4\">
                <div class=\"input-group mb-3 row\">
                <span for=\"tentruyen\" class=\"input-group-text col-3 d-flex justify-content-center\">Tên truyện</span>
                <input type=\"text\" class=\"form-control col-9\" name=\"ten_truyen\" value=\"{$row['ten_truyen']}\">
                
            </div>
            <div class=\"input-group mb-3 row\">
                <span for=\"tacgia\" class=\"input-group-text col-3 d-flex justify-content-center\">Tác giả</span>
                <input type=\"text\" class=\"form-control col-9\" name=\"tac_gia\" value=\"{$row['tac_gia']}\">
            </div>
            <div class=\"input-group mb-3 row\">
                <span for=\"theloai\" class=\"input-group-text col-3 d-flex justify-content-center\">Thể loại</span>
                <input type=\"text\" class=\"form-control col-9\" name=\"the_loai\" value=\"{$row['the_loai']}\">
            </div>
            <div class=\"input-group mb-3 row\">
            ...
            <div class=\"input-group mb-3 row\">
                ...
                <textarea class=\"form-control col-9\" spellcheck=\"false\" rows=\"10\" name=\"noi_dung\">{$row['noi_dung']}</textarea>
            </div>
